...
:: Android packaging
set AND_CERT_NAME="exDownloadManager"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exDownloadManager.p12
...
set IOS_PROVISION=cert\comdoitflashexDownloadManager.mobileprovision
...
set APP_ID=com.doitflash.exDownloadManager

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exDownloadManager
